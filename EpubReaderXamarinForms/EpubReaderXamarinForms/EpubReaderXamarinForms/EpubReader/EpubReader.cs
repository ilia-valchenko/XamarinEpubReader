...
using EpubReaderXamarinForms.EpubReader.RefEntities;
using EpubReaderXamarinForms.EpubReader.Interfaces;

namespace EpubReaderXamarinForms.EpubReader
{
    public static class EpubReader
    {
        ...
        /// <returns></returns>
        public static EpubBookRef OpenBook(string filePath, IFiler filer, IZipper zipper)
        {
            return OpenBookAsync(filePath, filer, zipper).Result;
        }
        ...
        /// <param name="filePath">path to the EPUB file</param>
        /// <returns></returns>
        public static async Task<EpubBookRef> OpenBookAsync(string filePath, IFiler filer, IZipper zipper)
        {
