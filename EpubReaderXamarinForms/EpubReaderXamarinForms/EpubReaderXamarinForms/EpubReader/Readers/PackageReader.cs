...
namespace EpubReaderXamarinForms.EpubReader.Readers
{
    ...
    {
        public static async Task<EpubPackage> ReadPackageAsync(string filepath/*ZipArchive epubArchive*/, string rootFilePath)
        {
            ...
            using (Stream containerStream = zipper.GetStream(filepath, rootFilePath))
            {
